...
Pod::Spec.new do |s|
	...
	s.source           	= {:git => "https://github.com/ArchieGoodwin/VialerSIPLib.git", :tag => s.version.to_s}
	...
	s.dependency 'Vialer-pjsip-iOS', :git => 'https://github.com/ArchieGoodwin/Vialer-pjsip-iOS.git'
